...
class TestAggregateTool:
    ...
    @pytest.mark.asyncio
    async def test_aggregate_blocks_out_in_read_only_mode(self, mock_ctx, patch_client, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_aggregate_blocks_merge_in_read_only_mode(self, mock_ctx, patch_client, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_aggregate_allows_out_when_write_enabled(self, mock_ctx, patch_client, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_aggregate_allows_merge_when_write_enabled(self, mock_ctx, patch_client, monkeypatch):
